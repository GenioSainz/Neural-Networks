...
## *Neural Network*
$$layers \textrm{ }l=0,1,2...L$$
$$layer(l-1)\rightarrow k \textrm{ } neurons$$
$$layer(l)  \rightarrow j \textrm{ } neurons$$
...
$$MiniBatches=X_1, X_2, \ldots,X_m$$
$$\frac{\sum_{j=1}^m \nabla C_{X_{j}}}{m} \approx \frac{\sum_{x=1}^n\nabla C_x}{n} = \nabla C$$
...
## *Update W,b using Stochastic Gradient Descent with Mini-Batches $X_j$*
