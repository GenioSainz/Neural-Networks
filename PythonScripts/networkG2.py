...
class CrossEntropyCost(object):
    ...
    def fn(a, y):
        ...
        stability.The np.nan_to_num ensures output (0.0) """
...
class Network(object):
    ...
    def default_weight_initializer(self):
        ...
        self.weights = [np.random.randn(r,c)/np.sqrt(c) for r, c in zip(self.rows,self.cols)]
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        lists: the (per-epoch) 
        the costs on the evaluation data, 
